    ...
    <div className="min-h-screen flex flex-col items-center p-4 sm:p-8 font-sans text-black">
      ...
      <div className="w-full max-w-[1216px] flex flex-col gap-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[320px_1fr] gap-0">
          ...
          {/* Sidebar */}
          <div className="w-full lg:w-[280px] shrink-0 bg-white rounded-xl border border-[#F4F4F5] p-5 flex flex-col h-fit">
                  ...
                  {editingNode && (
                    <motion.div 
                      ...
                      style={{ 
                        ...
                        top: editingNode.y,
                        transform: editingNode.y < 200 ? 'translate(-50%, 0%)' : 'translate(-50%, -100%)',
                        marginTop: editingNode.y < 200 ? '16px' : '-16px'
                      }}
                    >
                      <div className="flex justify-between items-center">
                      ...
                      return (
                        <button
                          ...
                          onClick={() => {
                            ...
                            if (unit === 'imperial') defaultTarget = mode === 'weightlifting' ? 120 * 2.20462 : 300 * 1.60934;
